...
export const EXPENSE_CATEGORY_TOKENS: Record<string, CategoryToken> = {
  ...
  dining:       { key: 'dining',       name: '外食',    color: '#fb923c', bg: '#fff4ee', icon: Utensils       },
  transport:    { key: 'transport',    name: '交通費',  color: '#60a5fa', bg: '#eff6ff', icon: Car            },
  utility:      { key: 'utility',      name: '光熱費',  color: '#fbbf24', bg: '#fffbeb', icon: Zap            },
  telecom:      { key: 'telecom',      name: '通信費',  color: '#818cf8', bg: '#eef2ff', icon: Smartphone     },
  housing:      { key: 'housing',      name: '住宅費',  color: '#d97706', bg: '#fffbeb', icon: Building2      },
  tax:          { key: 'tax',          name: '税金',    color: '#64748b', bg: '#f8fafc', icon: Landmark       },
  medical:      { key: 'medical',      name: '医療費',  color: '#fb7185', bg: '#fff1f2', icon: Heart          },
  insurance:    { key: 'insurance',    name: '保険',    color: '#f472b6', bg: '#fdf2f8', icon: Shield         },
  daily:        { key: 'daily',        name: '日用品',  color: '#38bdf8', bg: '#f0f9ff', icon: ShoppingBag    },
  education:    { key: 'education',    name: '教育費',  color: '#eab308', bg: '#fefce8', icon: GraduationCap  },
  beauty:       { key: 'beauty',       name: '美容費',  color: '#e879f9', bg: '#fdf4ff', icon: Scissors       },
  clothing:     { key: 'clothing',     name: '衣類',    color: '#a78bfa', bg: '#f5f3ff', icon: Shirt          },
  leisure:      { key: 'leisure',      name: '趣味',    color: '#c084fc', bg: '#faf5ff', icon: Music          },
...
export const INCOME_CATEGORY_TOKENS: Record<string, CategoryToken> = {
  unclassified: { key: 'unclassified', name: '未分類',      color: '#94a3b8', bg: '#f1f5f9', icon: CircleDashed     },
  salary:       { key: 'salary',       name: '給料',        color: '#2dd4bf', bg: '#f0fdfa', icon: Banknote         },
  bonus:        { key: 'bonus',        name: '賞与',        color: '#10b981', bg: '#ecfdf5', icon: Gift             },
  sideJob:      { key: 'sideJob',      name: '副業',        color: '#22c55e', bg: '#f0fdf4', icon: Briefcase        },
  benefit:      { key: 'benefit',      name: '手当',        color: '#0ea5e9', bg: '#f0f9ff', icon: Wallet           },
  pension:      { key: 'pension',      name: '年金',        color: '#14b8a6', bg: '#f0fdfa', icon: Users            },
  investment:   { key: 'investment',   name: '投資・配当',  color: '#34d399', bg: '#ecfdf5', icon: TrendingUp       },
  other:        { key: 'other',        name: 'その他',      color: '#94a3b8', bg: '#f8fafc', icon: Tag              },
}
